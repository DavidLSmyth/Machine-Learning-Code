...
# TO DO LIST:
#   weights DONE
#   count = 1000 for hist option DONE
#   gbm partial effects overlaid
#   options to use plotrix/base R for 2nd y axes,
#   can i automagically move legend out of the way? DIFFICULT
#   if this isnt different enough from rskups then focus on making it faster
#   d.t. + base graphics

junivar <- function(var.by=var.by,
...
#       junivar will sort it out (string) [optional] 
...
#
#   Junivar requires a function for binning continuous numerical variables 
...
#   binning). Pulled this out of junivar into its own function for easier 
#   maintenance. In the future I will modularize more of junivar. Plan to add 
